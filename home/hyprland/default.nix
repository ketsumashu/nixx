{ ... }: {
  imports = [ ./hyprcursor.nix ./hyprlock.nix ./xdph.nix ];
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    monitor =
      [ "HDMI-A-1,2560x1440@144,0x0,1" "HDMI-A-2,2560x1440@100,2560x0,1" ];
    ...
    animations = {
      ...
      bezier =
        [ "myBezier, 0.05, 0.9, 0.1, 1.05" "cubic, 0.1, 0.23, 0.41, 0.9" ];
      animation = [
