...
}:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    windowrule = [
      ...
      "match:class ^(steam)$, match:title:^(Steam - News), float"
      "match:class ^(steam)$, match:title:^(Friends List)$, float"
      "match:class ^(steam)$, match:title:(started)$, float"
      "match:class ^(steam)$, match:title:^(Add Non-Steam Game)$, float"
      "match:class ^(steam)$, match:title:^(Steam - Self Updater)$, float"
      "match:class ^(steam)$, match:title:(Manager)$, float"
      "match:class ^(steam)$, match:title:(フレンドリスト)$, float"
      "match:class ^(steam)$, match:title:^(Steam Guard - Computer Authorization Required)$, float"
    ];
